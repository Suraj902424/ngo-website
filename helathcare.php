...
<body>
   ...
   <?php include 'include/loader.php'; ?>
    ...
    <div class="container-fluid bg-primary py-5 text-white text-center">
        <h1 class="display-5 fw-bold">Bringing Health and Hope to the Needy</h1>
        <p class="lead mb-0">Health is the foundation of happiness and progress.</p>
    </div>
    ...
    <div class="container py-5">
        <div class="row g-4 align-items-center">
            <div class="col-lg-6">
                <img src="img/courses-3.jpg" class="img-fluid rounded shadow" alt="Healthcare support">
            </div>
            <div class="col-lg-6">
                <h2 class="text-primary mb-4">Our Healthcare Program</h2>
                <p>
                    We organize free health check-ups, medical camps, and distribute essential medicines.
                    Our volunteers reach remote areas where medical facilities are unavailable.
                </p>
                <p>
                    Join us in creating a healthier, happier, and stronger India.
                </p>
