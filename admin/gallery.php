...
if (isset($_POST['save'])) {
    ...
    if ($id == "") {
        $sql = "INSERT INTO gallery (title, image, meta_title, meta_description, meta_keywords)
                VALUES ('$title', '$img_name', '$meta_title', '$meta_description', '$meta_keywords')";
    } else {
...
ob_end_flush(); // Output flush करें
?>
...
<div class="form-container">
    <h2><?= $id ? 'Edit' : 'Add' ?> Gallery Image</h2>
